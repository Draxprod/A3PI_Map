...
class CfgWorlds
{
	...
	class A3PI_Map: CAWorld
	{
		...
		worldId = 1337;
		cutscenes[] = {""};
		description = "A3PI MAP";
		icon = "";
		worldName = "A3PI_Map\A3PI_Map.wrp";
		previewVideo = "A3\Map_Altis_Scenes_F\Video\previewVideo.ogv";
		pictureMap = "A3PI_Map\source\satellite.paa";
		pictureShot = "A3PI_Map\source\satellite.paa";
		plateFormat = "A#$-####";
		...
		newRoadsShape = "\A3PI_Map\data\roads\roads.shp";
		...
		*/
		...
		loadingTexts[] = {"A3PI est une carte créer par Drax pour le projet A3PI.fr en novembre 2016"/*,"A3PI.fr vu le jour en ouverture ALPHA en février 2017","Cette carte est réserver uniquement et seulement a A3PI.fr","ARMA3 PROJECT ISLAND par Drax","Nous remercions nos 15000 membres actifs sur A3PI.fr","Gameblog - C'est un projet fou mais réalisable, A3PI est le futur du monde du RolePlay. Vive A3PI.fr","Grâce à nos partenariats nous pouvons vous offrir une qualité de jeu incroyable sur A3PI.fr","Savez-vous qu'A3PI a été fondé sur un coup de tête le 04 Novembre 2016? Ce coup de tête est devenu un coup de bluffe incroyable qui revolutionna le monde du roleplay d'ArmA3"*/};
	};
};
class CfgWorldList
{
